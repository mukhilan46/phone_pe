...
if select == "Home":
    ...
    with col2:
        st.video("C:\\Users\\ #your_username \\Desktop\\CAPSTONE Projects\\phone pe\\Phone Pe Ad(720P_HD).mp4")

    col3,col4= st.columns(2)
    
    with col3:
        st.video("C:\\Users\\ #your_username \\Desktop\\CAPSTONE Projects\\phone pe\\PhonePe Motion Graphics(720P_HD).mp4")
    ...
    with col6:
        st.video("C:\\Users\\ #your_username \\Desktop\\CAPSTONE Projects\\phone pe\\PhonePe Motion Graphics(720P_HD)_2.mp4")
